...
fun OpnameDto.toDomain(): StockOpname =
    StockOpname(
        uuid = uuid,
        opnameNo = opnameNo,
        status = status,
...
fun OpnameItemDto.toDomain(): OpnameItem =
    OpnameItem(
...
fun OpnameDetailDto.toDomain(): StockOpnameDetail =
    StockOpnameDetail(
        opname =
            StockOpname(
                uuid = uuid,
...
fun PurchaseOrderItemDto.toDomain(): PurchaseOrderItem =
    PurchaseOrderItem(
        uuid = uuid,
        productUuid = productUuid,
        productName = productName,
...
fun PurchaseOrderDto.toDomain(): PurchaseOrder =
    PurchaseOrder(
        uuid = uuid,
        poNumber = poNumber,
