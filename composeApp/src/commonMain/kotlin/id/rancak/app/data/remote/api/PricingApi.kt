...
suspend fun RancakApiService.getSurcharge(
    tenantUuid: String,
    surchargeId: String,
...
suspend fun RancakApiService.deleteSurcharge(
    tenantUuid: String,
    surchargeId: String,
): ApiResponse<Unit> =
...
suspend fun RancakApiService.getTaxConfig(
    tenantUuid: String,
    configId: String,
...
suspend fun RancakApiService.deleteTaxConfig(
    tenantUuid: String,
    configId: String,
): ApiResponse<Unit> =
...
suspend fun RancakApiService.getVoucher(
    tenantUuid: String,
    voucherId: String,
...
suspend fun RancakApiService.deleteVoucher(
    tenantUuid: String,
    voucherId: String,
): ApiResponse<Unit> =
...
suspend fun RancakApiService.getDiscountRule(
    tenantUuid: String,
    ruleId: String,
...
suspend fun RancakApiService.deleteDiscountRule(
    tenantUuid: String,
    ruleId: String,
): ApiResponse<Unit> =
...
suspend fun RancakApiService.getBundle(
    tenantUuid: String,
    bundleId: String,
...
suspend fun RancakApiService.deleteBundle(
    tenantUuid: String,
    bundleId: String,
): ApiResponse<Unit> =
...
suspend fun RancakApiService.getModifier(
    tenantUuid: String,
    modifierId: String,
...
suspend fun RancakApiService.deleteModifier(
    tenantUuid: String,
    modifierId: String,
): ApiResponse<Unit> =
