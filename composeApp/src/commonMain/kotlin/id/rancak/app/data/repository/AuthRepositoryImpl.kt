...
class AuthRepositoryImpl(
    ...
    override fun setTenant(
        uuid: String,
        name: String,
    ) = tokenManager.setTenant(uuid, name)
    ...
    override fun getSubscriptionStatus(): String? = tokenManager.subscriptionStatus

    override fun setSubscriptionStatus(status: String?) = tokenManager.setSubscriptionStatus(status)
