...
class BillingRepositoryImpl(
    ...
    override suspend fun getBillingPlans(): Resource<List<Plan>> =
        safe(
    ...
    override suspend fun getSubscription(): Resource<SubscriptionState> =
        safe(
    ...
    override suspend fun getInvoice(invoiceUuid: String): Resource<Invoice> =
        safe(
    ...
    override suspend fun cancelInvoice(invoiceUuid: String): Resource<Unit> =
        safeUnit(
