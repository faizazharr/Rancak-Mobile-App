...
import id.rancak.app.data.remote.api.closeShift
import id.rancak.app.data.remote.api.getCashCounts
import id.rancak.app.data.remote.api.getCurrentShift
import id.rancak.app.data.remote.api.getDiscountRules
import id.rancak.app.data.remote.api.getKdsDetail
import id.rancak.app.data.remote.api.getKdsOrders
import id.rancak.app.data.remote.api.getShiftSummaryById
import id.rancak.app.data.remote.api.getSurcharges
import id.rancak.app.data.remote.api.getTables
import id.rancak.app.data.remote.api.getTaxConfigs
import id.rancak.app.data.remote.api.openShift
import id.rancak.app.data.remote.api.previewDiscount
import id.rancak.app.data.remote.api.submitCashCount
import id.rancak.app.data.remote.api.syncCatalog
import id.rancak.app.data.remote.api.syncStatus
import id.rancak.app.data.remote.api.updateKdsItemStatus
import id.rancak.app.data.remote.api.updateKdsStatus
import id.rancak.app.data.remote.api.validateVoucher
