...
class ReservationRepositoryImpl(
    ...
    override suspend fun createReservation(input: ReservationInput): Resource<Reservation> =
        safe(
            block = {
    ...
    override suspend fun deleteReservation(reservationId: String): Resource<Unit> =
        safeUnit(
    ...
    override suspend fun seatReservation(
        reservationId: String,
        tableUuid: String,
    ): Resource<Reservation> =
        safe(
