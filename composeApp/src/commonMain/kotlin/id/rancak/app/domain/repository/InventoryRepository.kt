...
interface InventoryRepository {
    ...
    suspend fun upsertOpnameItems(
        opnameId: String,
        items: List<OpnameItemEntry>,
    ): Resource<Unit>

    suspend fun deleteOpnameItem(
        opnameId: String,
        productUuid: String,
    ): Resource<Unit>
    ...
    suspend fun addPurchaseOrderItem(
        poId: String,
        item: POItemEntry,
    ...
    suspend fun deletePurchaseOrderItem(
        poId: String,
        itemId: String,
    ): Resource<Unit>
