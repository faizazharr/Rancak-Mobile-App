...
interface SaleRepository {
    ...
    suspend fun paySaleWithSplitPayment(
        saleUuid: String,
        payments: List<SplitPaymentEntry>,
    ): Resource<Sale>
    ...
    suspend fun getReceiptCombined(
        saleUuid: String,
