...
fun PaymentScreen(
    ...
    val taxLines: ImmutableList<NamedAmount> =
        remember(cartState) {
            buildList {
    ...
    val surchargeLines: ImmutableList<NamedAmount> =
        remember(cartState) {
            buildList {
    ...
    val onConfirmAndPrint: (Long) -> Unit = { groupActualTotal ->
        ...
        val receiptItems =
            state.splitableItems.mapNotNull { item ->
            ...
            RancakTopBar(
                ...
                subtitle =
                    if (paymentState.isSplitPayment) {
                        "Bayar terpisah dengan beberapa metode"
                    } else {
                        "Pilih metode & masukkan jumlah bayar"
                    },
                onBack = onBack,
            )
        },
