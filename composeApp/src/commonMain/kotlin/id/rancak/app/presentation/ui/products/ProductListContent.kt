...
private fun CategorySidePanel(
    ...
    Column(
        ...
        val countByCat: Map<String?, Int> =
            remember(uiState.selectedCategory, uiState.products) {
            ...
            AnimatedVisibility(
                ...
                Row {
                    AnimatedContent(
                        ...
                        transitionSpec = {
                            (fadeIn(tween(160)) + scaleIn(tween(160), initialScale = 0.7f)) togetherWith (fadeOut(tween(120)) + scaleOut(tween(120), targetScale = 0.7f))
                        },
                        label = "SortIconEnd",
                    ) { asc ->
                        Icon(
        ...
        Column(
            ...
            Box(
                Modifier.fillMaxWidth(
                    0.33f,
                ).height(10.dp).clip(MaterialTheme.shapes.extraSmall).alpha(alpha * 0.6f).background(shimmerColor),
            )
        }
        Row(
            modifier = Modifier.width(110.dp),
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(6.dp)) {
                    ...
                    Box(
                        Modifier.fillMaxWidth(
                            0.4f,
                        ).height(11.dp).clip(MaterialTheme.shapes.extraSmall).alpha(alpha * 0.6f).background(shimmerColor),
                    )
                    Box(
                        Modifier.fillMaxWidth(
                            0.28f,
