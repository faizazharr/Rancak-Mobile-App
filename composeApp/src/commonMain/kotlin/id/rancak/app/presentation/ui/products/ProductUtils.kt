...
internal fun Double.toStockDisplay(): String = if (this == toLong().toDouble()) toLong().toString() else toString()
...
internal fun generateBarcode(): String = Random.nextLong(100_000_000_000L, 999_999_999_999L).toString()
