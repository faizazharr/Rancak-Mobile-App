...
class FakeProductDao : ProductDao {
    ...
    override suspend fun findByBarcode(barcode: String): ProductEntity? = products.firstOrNull { it.barcode == barcode }
...
class FakeSaleDao : SaleDao {
    ...
    override suspend fun upsertSalesWithItems(
...
class FakeAdminRepository : id.rancak.app.domain.repository.AdminRepository {
    ...
    override suspend fun createSurcharge(
        ...
        maxAmount: String?,
        sortOrder: Int,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Surcharge> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun getVouchers(
        ...
        page: Int,
        limit: Int,
    ): id.rancak.app.domain.model.Resource<List<id.rancak.app.domain.model.Voucher>> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createVoucher(
        ...
        validUntil: String?,
        isActive: Boolean,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Voucher> = id.rancak.app.domain.model.Resource.Error("unused")

    override suspend fun updateVoucher(
        voucherId: String,
        update: id.rancak.app.domain.repository.VoucherUpdate,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Voucher> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createTaxConfig(
        ...
        applyTo: String,
        sortOrder: Int,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.TaxConfig> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createTable(
        ...
        isActive: Boolean,
        sortOrder: Int,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Table> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createBundle(
        name: String,
        price: String,
        items: List<id.rancak.app.domain.repository.BundleItemEntry>,
        description: String?,
        sku: String?,
        isActive: Boolean,
        sortOrder: Int,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Bundle> = id.rancak.app.domain.model.Resource.Error("unused")

    override suspend fun updateBundle(
        bundleId: String,
        update: id.rancak.app.domain.repository.BundleUpdate,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Bundle> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createModifier(
        ...
        sortOrder: Int,
        isActive: Boolean,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Modifier> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createDiscountRule(
        ...
        maxDiscount: Double?,
        isActive: Boolean,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.DiscountRule> = id.rancak.app.domain.model.Resource.Error("unused")

    override suspend fun updateDiscountRule(
        ruleId: String,
        update: id.rancak.app.domain.repository.DiscountRuleUpdate,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.DiscountRule> = id.rancak.app.domain.model.Resource.Error("unused")

    override suspend fun deleteDiscountRule(ruleId: String): id.rancak.app.domain.model.Resource<Unit> =
        id.rancak.app.domain.model.Resource.Error("unused")

    override suspend fun getVariantGroups(
        productId: String,
    ): id.rancak.app.domain.model.Resource<List<id.rancak.app.domain.model.VariantGroup>> =
        id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createVariantGroup(
        ...
        isRequired: Boolean,
        sortOrder: Int,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.VariantGroup> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun deleteVariantGroup(
        productId: String,
        groupId: String,
    ): id.rancak.app.domain.model.Resource<Unit> = id.rancak.app.domain.model.Resource.Error("unused")

    override suspend fun getVariants(
        productId: String,
        groupId: String,
    ): id.rancak.app.domain.model.Resource<List<id.rancak.app.domain.model.Variant>> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createVariant(
        ...
        isActive: Boolean,
        sortOrder: Int,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Variant> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun getProductBatches(
        productId: String,
    ): id.rancak.app.domain.model.Resource<List<id.rancak.app.domain.model.ProductBatch>> =
        id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createProductBatch(
        ...
        note: String?,
        receivedAt: String?,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.ProductBatch> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createProduct(
        ...
        hasExpiry: Boolean,
        isActive: Boolean,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Product> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun createCategory(
        name: String,
        description: String?,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.Category> = id.rancak.app.domain.model.Resource.Error("unused")
    ...
    override suspend fun updateReceiptSettings(
        update: id.rancak.app.domain.repository.ReceiptSettingsUpdate,
    ): id.rancak.app.domain.model.Resource<id.rancak.app.domain.model.ReceiptSettingsConfig> =
        id.rancak.app.domain.model.Resource.Error("unused")
}
